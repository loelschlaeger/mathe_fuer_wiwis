...
\frame{\question{Ist die Division assoziativ?}{100}}
...
\frame{\question{Ist $-3$ im Definitionsbereich von $\displaystyle f(x) = \frac{1}{3+x}$~?}{100}}
\frame{\question{Wie viel ist $\displaystyle \sum_{i=1}^4 i$~?}{100}}
