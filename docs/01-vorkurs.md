...
Die Ableitung einer Funktion $f(x)$ ist eine Funktion $f'(x)$, die für jedes $x$ die Änderungsrate von $f$ berechnet.

<img src="01-vorkurs_files/figure-html/ableitung-1.png" width="100%" />

### Integration

Das Integral einer Funktion ist die Fläche unter der Funktion

<img src="01-vorkurs_files/figure-html/integral-1.png" width="100%" />
